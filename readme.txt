...
Orthodox church memos on your site.
...
Чтобы установить кнопку в виджет, Вы можете воспользоваться следующим html-кодом: `<button onclick='memos_button();'> Записки в храм </button>`
